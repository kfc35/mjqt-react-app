...
function Footer() {
    ...
    <>
        ...
        If you or someone you know is struggling with a gambling problem, please contact the <a href="https://www.ncpgambling.org/help-treatment/" target="_blank" rel="noreferrer">National Problem Gambling Helpline</a>.
        </p>
        <p>
        Made with 
