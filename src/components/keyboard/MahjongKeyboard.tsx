...
import MahjongKeys from './mahjongKeys/MahjongKeys';
...
function MahjongKeyboard(props: MahjongKeyboardProps) {
    ...
    <>
        ...
        <MahjongKeys createOnTileClickPushToCorrectField={createOnTileClickPushToCorrectField} tileButtonDisabled={tileButtonDisabled} />
